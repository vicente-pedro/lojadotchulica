...
Repositório dedicado ao **desenvolvimento completo do site da Loja do Tchulica**, empresa especializada em **manutenção de celulares**, **venda de aparelhos** e **acessórios para smartphones**.

---

## 🧭 Objetivo do Repositório
Centralizar todo o processo de desenvolvimento do site, incluindo:
- O que **precisa ser feito**
- O que **já foi concluído**
- O **código-fonte** do projeto
- O **acompanhamento das tarefas e atualizações**

            ...
            {cart.map(item => (
              <div key={item.id} className="cart-item">
                ...
                <div className="cart-item-info">
                  ...
                  {item.selectedColor && (
                    <p className="cart-item-color">Cor: {item.selectedColor}</p>
                  )}
                ...
                <div className="cart-item-actions">
                  ...
                  <div className="cart-item-total">
                    ...
                    <span className="total-value">R$ {(item.price * item.quantity).toLocaleString('pt-BR', { minimumFractionDigits: 2 })}</span>
                  </div>
          ...
          <aside className="cart-summary">
            ...
            <div className="summary-details">
              ...
              <div className="summary-row summary-total">
                <span>Total:</span>
                <span>R$ {(getTotalPrice() + (freteValor ? parseFloat(freteValor.replace(",", ".")) : 0)).toLocaleString("pt-BR", { minimumFractionDigits: 2, maximumFractionDigits: 2 })}</span>
              </div>
            </div>

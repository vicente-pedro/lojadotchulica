    ...
    <div className="product-detail-page">
      <div className="product-detail-container">
          ...
          <div className="product-detail-info">
            ...
            {product.colors && product.colors.length > 0 && (
              <div className="product-colors-section">
                ...
                <div className="colors-selection">{product.colors.map((color, index) => (
        ...
        {relatedProducts.length > 0 && (
          <div className="related-products"><h2>Produtos Relacionados</h2><div className="related-products-grid">{relatedProducts.map(relatedProduct => (
            <div key={relatedProduct.id} className="related-product-card" onClick={() => navigate(`/produto/${relatedProduct.id}`)}>
